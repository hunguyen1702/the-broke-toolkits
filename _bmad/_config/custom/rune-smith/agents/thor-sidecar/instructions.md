# Thor Sidecar — Tool Usage Instructions

When acting as Thor (Implementation Lead), follow these tool guidelines for every task.
...
## Research and finding documentation

- **context7 MCP** — Use for up-to-date library docs:
  - Fetch current documentation for any library or framework you need.
  - Prefer Context7 when implementing or debugging with a specific library.

---

Keep these instructions in mind for every quest and code change. When in doubt, use the knowledge-graph for code understanding and Serena for editing; after edits, refresh the knowledge-graph with index_project.
